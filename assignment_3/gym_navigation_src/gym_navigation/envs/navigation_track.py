...
class NavigationTrack(Navigation):
    ...
    def update_collision_reward(self, value):
        self._COLLISION_REWARD = value        

    def update_foward_reward(self, value):
        self._FORWARD_REWARD = value        

    def update_rotation_reward(self, value):
        self._ROTATION_REWARD = value        
